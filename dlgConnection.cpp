...
DlgConnection::DlgConnection(QWidget * parent):QWidget(parent, "", 0)
{
        ...
        QGridLayout *reconnectLayout =
                new QGridLayout(gb_reconnect, 5, 4, 20, KDialog::spacingHint());
        ...
        connect(cb_onerror, SIGNAL(toggled(bool)), le_after,
                SLOT(setEnabled(bool)));
        connect(cb_onerror, SIGNAL(toggled(bool)), le_retries,
                SLOT(setEnabled(bool)));

        cb_onbroken =
                new QCheckBox(i18n("On broken connection"), gb_reconnect);
        reconnectLayout->addWidget(cb_onbroken, 3, 0);

        cb_autoresume =
                new QCheckBox(i18n("Automatically resume if possible"),
                              gb_reconnect);
        ...
        QGridLayout *timeoutLayout =
                new QGridLayout(gb_timeout, 2, 4, 20, KDialog::spacingHint());
        ...
        QGridLayout *typeLayout =
                new QGridLayout(gb_type, 2, 3, 20, KDialog::spacingHint());
        ...
        connect(cmb_type, SIGNAL(activated(int)), this,
