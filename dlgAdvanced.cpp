...
DlgAdvanced::DlgAdvanced(QWidget * parent):QGroupBox(parent)
{
        ...
        QGridLayout *gridLayout =
                new QGridLayout(this, 7, 3, 20, KDialog::spacingHint());
        ...
        connect(cb_individual, SIGNAL(toggled(bool)), cb_iconify,
        ...
        //
        cb_remove =
                new QCheckBox(i18n("Remove files from a list after success"),
                              this);
...
void DlgAdvanced::applyData()
{
        ...
        //KProtocolManager::setMarkPartial(cb_partial->isChecked());
}
