...
GenericName[sa]=डाउनलोड प्रबन्धक
...
GenericName[ug]=چۈشۈرۈش باشقۇرغۇچ
...
Comment[ar]=كجت هو مدير تنزيل متعدد الاستخدامات وسهل الاستخدام
Comment[bg]=KGet е гъвкава и потребителска ориентирана програма за управления на изтегляния
Comment[ca]=El KGet és un gestor de baixades versàtil i fàcil d'emprar
Comment[ca@valencia]=KGet és un gestor de baixades versàtil i fàcil d'emprar
Comment[cs]=KGet je všestranný a jednoduše použitelný správce stahování
Comment[da]=KGET er en alsidig og brugervenlig downloadhåndtering
...
Comment[eo]=KGet estas diverspova kay uzant-amika elŝutadministrilo
...
Comment[ga]=Tá KGet ilghnéitheach agus so-úsáidte bainisteoir íosluchtaigh
Comment[gl]=KGet é un xestor de descargar versátil e fácil de usar.
Comment[he]=KGet הוא מנהל הורדה ידידותי וגמיש
...
Comment[sa]=KGet बहुमुखी उपयोक्तृ-अनुकूलः च डाउनलोड्-प्रबन्धकः अस्ति
...
Comment[tr]=K İndir, çok kapsamlı ve kullanıcı dostu bir indirme yöneticisidir
Comment[uk]=KGet — гнучка і зручна програма для отримання даних з мережі
Comment[zh_CN]=KGet 是一个功能多样且用户友好的下载管理器
Comment[zh_TW]=KGet 是一個多功能且對使用者友善的檔案下載管理員
