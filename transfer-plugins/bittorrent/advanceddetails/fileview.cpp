    ...
    , model(nullptr)
{
    ...
    connect(this, &QWidget::customContextMenuRequested, this, &FileView::showContextMenu);
    connect(this, &QAbstractItemView::doubleClicked, this, &FileView::onDoubleClicked);
...
void FileView::changeTC(bt::TorrentInterface *tc, KSharedConfigPtr cfg)
{
    ...
    if (tc) {
        connect(tc, &TorrentInterface::missingFilesMarkedDND, this, &FileView::onMissingFileMarkedDND);
