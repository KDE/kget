	...
	QVariant PeerViewModel::headerData(int section, Qt::Orientation orientation,int role) const
	{
		...
		else if (role == Qt::ToolTipRole)
		{
			switch (section)
			{
				...
				case 4: return i18n("Whether or not the peer has choked us, when we are choked the peer will not send any data to us");
				case 5: return i18n("Snubbed means the peer hasn't sent us any data in the last 2 minutes");
				case 6: return i18n("How much data the peer has of the torrent");
				...
				case 11: return i18n("How much data we downloaded from this peer");
				case 12: return i18n("How much data we uploaded to this peer");
